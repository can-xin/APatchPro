...
public class APatchKeyHelper {
    ...
    public static int readKeyAuthMode() {
        return prefs.getInt(KEY_AUTH_MODE, 0);
    }

    public static void writeKeyAuthMode(int mode) {
        prefs.edit().putInt(KEY_AUTH_MODE, mode).apply();
    }
